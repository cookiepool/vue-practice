...
<div v-if="show" @touchmove.prevent>
    ...
    <div class="update_pop tc flex_column_center">
        <img class="cat" src="https://static.cattryapp.com/12static/new/img/common_wxbind_icon.png">
        <img class="cancel" @click="closepop" src="https://static.cattryapp.com/12static/new/img/cancel.png">
        <h2>提示</h2>
        <h3>当前账号无法保障收益 请尽快<span>绑定微信</span></h3>
        <div ref="bind" class="update_btn flex_all_center" @click="startUpdate">去绑定</div>
    </div>
</div>  
</template>
<script>
...
.update_pop{
    ...
    padding: 4.28rem 4.4286rem 2.2857rem;
